...
5. Target length: ~{target_words} words (~{int(target_words / 150 * 60)} seconds at 150 wpm). HARD CAP: never exceed {int(target_words * 1.3)} words total. Count every word before submitting.
