---
name: banner-design
description: "Design banners for social media, ads, website heroes, creative assets, and print. Multiple art direction options with AI-generated visuals. Actions: design, create, generate banner. Platforms: Facebook, Twitter/X, LinkedIn, YouTube, Instagram, Google Display, website hero, print. Styles: minimalist, gradient, bold typography, photo-based, illustrated, geometric, retro, glassmorphism, 3D, neon, duotone, editorial, collage. Uses ui-ux-pro-max, frontend-design, ai-artist, ai-multimodal skills. Triggers on 'banner design', 'design banner', 'create banner', 'generate banner', 'social media banner', 'website hero', 'ad banner'."
...
Before declaring a banner ready for delivery, run `/design-audit <path-to-banner>`. Two paths:

- **HTML banners** (rendered via screenshot): `/design-audit <banner.html>` — scores the source HTML against the 5-dim Impeccable rubric.
- **AI-generated pixel banners** (Gemini, Kie): `/design-audit --image <banner.png>` — uses Sonnet 4.6 vision to score the rendered image against typography, palette, composition, and AI-slop signatures.

**Required scores to ship:**
- Total ≥ 15/20
- Anti-patterns ≥ 3/4
- For Catalyst Works branded banners: ≥ 17/20

**Common banner failures:** category-reflex palette (every dental banner is bright-blue + tooth icon, every consulting banner is navy + gold), reflex-reject font baked into the prompt, gradient text overlays, three-column equal-weight layouts. Style guidance for the prompt (banner-design references) should reference the CURRENT styleguide version, not a legacy one.
