...
function buildSavingsTab(spreadsheetId, sheetId) {
  ...
  batchUpdate(spreadsheetId, [{
    updateCells: {
      ...
      rows: [{
        values: [
          { userEnteredValue: { stringValue: 'TOTAL EPARGNE' },
            userEnteredFormat: { textFormat: { fontSize: 8, foregroundColor: COLORS.muted } } },
          ...
          { userEnteredValue: { stringValue: 'TOTAL OBJECTIF' },
            userEnteredFormat: { textFormat: { fontSize: 8, foregroundColor: COLORS.muted } } },
  ...
  // Note: fr_FR locale rejects decimal point in CF formulas; use E5*2>=1 instead of E5>=0.5
  batchUpdate(spreadsheetId, [
      ...
      updateCells: {
        ...
        rows: [
          ...
          { values: [{ userEnteredValue: {
              formulaValue: '=TEXT(IFERROR(BUDGET!D2/BUDGET!B2*100,0),"0")&"% du revenu"' },
            userEnteredFormat: { textFormat: { fontSize: 8, foregroundColor: COLORS.muted } } }] },
        ],
        fields: 'userEnteredValue,userEnteredFormat.numberFormat,userEnteredFormat.textFormat'
      }
    ...
    bgColor(sheetId, 6, 10, 5, 10, COLORS.white),
    {
      updateCells: {
        ...
        rows: [
          ...
          { values: [{ userEnteredValue: { formulaValue: '=EPARGNE!G5' },
            userEnteredFormat: { textFormat: { fontFamily: 'Courier New', fontSize: 10,
              foregroundColor: COLORS.sage } } }] },
          { values: [{ userEnteredValue: {
              formulaValue: '=EPARGNE!C5&" / "&EPARGNE!B5&" € · "&TEXT(EPARGNE!E5,"0%")' },
