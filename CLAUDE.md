...
### frontend-design Skill — Mandatory for All Website Work
**Trigger**: Any task that creates, updates, or reviews a website, landing page, or HTML/CSS artifact.
**Action**: Invoke the `frontend-design` skill BEFORE writing any code. No exceptions — this applies to new sites, redesigns, section updates, and single-page tweaks. The skill loads the correct awesome-design-md reference and/or Catalyst Works styleguide, states a design brief, then proceeds to code.
